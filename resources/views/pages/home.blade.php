...
@section('content')
    ...
    {{-- Header --}}
    {{-- Video
    <section class="bg-video behind-layer w-500">
    <video autoplay="autoplay" loop="loop" class="w-500" muted="muted">
      <source src="{{ url('frontend/images/Wonderful Indonesia - Yogyakarta.mp4') }}" type="video/mp4">
