...
<div class="container-fluid">
    ...
    <div class="col-xl-3 col-md-6 mb-4">
        ...
        <div class="card-body">
            ...
            <div class="col mr-2">
                <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Paket Wisata</div>
                <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $tour_package }}</div>
            </div>
            <div class="col-auto">
    ...
    <div class="col-lg-6 mb-4">
        ...
        <div class="card-body">
            ...
            <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 25rem;" src="{{ url('img/undraw_posting_photo.svg') }}" alt="">
            </div>
